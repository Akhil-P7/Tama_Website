        ...
        '@graph': [
          {
            ...
            logo: {
              '@type': 'ImageObject',
              url: `${siteUrl}/images/tama-sprout-mark-512.png`,
              width: 512,
              height: 512,
            },
          ...
          },
          {
            ...
            description: config.public.siteDescription,
            url: `${siteUrl}/`,
            image: `${siteUrl}/images/tama-sprout-mark-512.png`,
            screenshot: [
              `${siteUrl}/images/tama_open_lifebook.png`,
              `${siteUrl}/images/tama_cozy_night.png`,
            ],
